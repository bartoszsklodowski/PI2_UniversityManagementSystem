...
namespace University.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            UniversityDbContext context) // Dodaj to
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Dodanie użytkownika do roli "student"
                    await _userManager.AddToRoleAsync(user, "Student");

                    // Tworzenie wpisu w tabeli Student
                    var student = new Student
                    {
                        ...
                        Email = Input.Email,
                        Enrollmentyear = DateOnly.FromDateTime(DateTime.Now),
                        Financialbalance = 0
                    };
