...
namespace University.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            public DateOnly? EnrollmentYear { get; }
            public decimal Financialbalance { get; }
        }
        ...
        private async Task LoadAsync(ApplicationUser user)
        {
            ...
            DateOnly? enrollmentYear = null;
            decimal financialbalance = 0;
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            // Aktualizacja pól Firstname i Lastname w tabeli AspNetUsers
